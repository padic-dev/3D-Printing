...
#define STRING_CONFIG_H_AUTHOR "(padic, Lucy)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "20200806.a"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Lucy - Houkr Metal Hotend -> 200C (M303 E0 C8 S200)
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Stock bed with Creality magnetic PEI spring steel plate
  #define DEFAULT_bedKp 237.54
  #define DEFAULT_bedKi 46.03
  #define DEFAULT_bedKd 817.31
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -43.64, -5.73, 0.00 }
...
#define Z_HOMING_HEIGHT  50      // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ... //Customized DBP
