...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Lucy - Houkr Metal Hotend -> 200C
  #define DEFAULT_Kp 23.291
  #define DEFAULT_Ki 1.125
  #define DEFAULT_Kd 120.529
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Ender 3 Stock heat bed - Borosilicate glass + pei sheet -> 60C
  #define DEFAULT_bedKp 72.526
  #define DEFAULT_bedKi 1.351
  #define DEFAULT_bedKd 973.662
